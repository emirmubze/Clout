...
class SeoOptimizationTests(TestCase):
    ...
    def test_homepage_favicon_tags(self):
        response = self.client.get(reverse("index"))
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, '<link rel="icon" type="image/png" sizes="32x32" href="/static/favicon-32x32.png?v=5">')
        self.assertContains(response, '<link rel="icon" type="image/png" sizes="16x16" href="/static/favicon-16x16.png?v=5">')
        self.assertContains(response, '<link rel="icon" type="image/png" sizes="512x512" href="/static/favicon-512x512.png?v=5">')
        self.assertContains(response, '<link rel="icon" type="image/png" sizes="192x192" href="/static/favicon-192x192.png?v=5">')
        self.assertContains(response, '<link rel="icon" type="image/png" sizes="48x48" href="/static/favicon-48x48.png?v=5">')
        self.assertContains(response, '<link rel="apple-touch-icon" sizes="180x180" href="/static/apple-touch-icon.png?v=5">')
